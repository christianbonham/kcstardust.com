      ...
      <div className="kcs">
        ...
        <div className="bio">
          ...
          <p>
            ...
            career in UX/UI and Front-end development at Cisco Systems. I would
            spend the next 20 years collaborating with a large cross function
            team on every major project on Cisco.com. When I left Cisco I was
            leading a dozen engineers all over the world, working hand in hand
            with digital marketing designers, developing and supporting code for
        ...
        <div className="bio">
          ...
          <p>
            Instructional design combines my passions for education, technology,
            and design. I strive to create experiences that are memorable and
            create lasting impacts that help organizations thrive.
          </p>
          <p>
            I am a learning &amp; development professional with nearly a decade
            of experience. I began my journey into training &amp; development in
            ...
            companies to help develop business processes, launch new teams, and
            train staff. I studied instructional design and e-learning
            development at the University of Washington, and have since worked
            with teams as both a freelance consultant and in-house learning
            experience designer.
          </p>
        </div>
      </div>
