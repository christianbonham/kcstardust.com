...
export default function UXDevelopment(props: PropsWithChildren<{}>) {
  return (
    <>
      ...
      <Row background="white" colStyle={{ flexWrap: 'wrap' }}>
        <div className="kcs">
          ...
          <p>
            ...
            provide effective development services uses the latest technologies
            and disciplines.
          </p>
      ...
      <Row background="grey" colStyle={{ flexWrap: 'wrap' }}>
        <div className="kcs">
          ...
          <p>
            ...
            teams. From wireframes to high fidelity functional mockups, we
