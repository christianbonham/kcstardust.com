    ...
    <>
      ...
      <Row rowColor="white" contentColor="white">
        <Column>
          <div className="kcs">
            <h2 className="flair">
              What can KC Stardust do for your business?
            </h2>
            <p className="large">
            ...
            <p>
              ...
              experiences, streamline operations of multiple L&D teams, and
              reduce average GTM times of training programs from over 6 months
            ...
            <p>
              Designed and launched a 0-1 global onboarding curriculum for a
              major retail clothing brand. Outcomes of program include: over 98%
              learner approval rating of program, decrease in onboarding costs
              by over 90%, and secondary metric effects such as significant
              reduction in IT ticketing times.{' '}
            </p>
            <i>
